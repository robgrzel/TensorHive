...
class NodeModel(Base):
    ...
    reservation_events = relationship("ReservationEventModel", backref="node")

    def __repr__(self):
        return '<Node: id={self.id}, username={self.username}, hostname={self.hostname}, created_at={self.created_at}>'
